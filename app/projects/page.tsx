...
'https://res.cloudinary.com/olhrhert/image/upload/v1784209501/chrome_Nc2xlaX5iR_jiagjm.png',
 'https://res.cloudinary.com/olhrhert/image/upload/v1784209501/chrome_r2Htgs08qI_asfdjk.png',
  ...
  description: 'تطبيق موبايل مخصص للوكلاء العقاريين لإدارة عقاراتهم المعروضة، متابعة طلبات العملاء والمعاينات، والتواصل المباشر مع العملاء المهتمين بكل سهولة',
  category: 'Real Estate',
  tech: ['Flutter', 'sql', 'BLoC', 'REST API'],
  architecture: 'Clean Architecture',
  demo: '#',
  ...
  highlights: [
    ...
    'متابعة طلبات المعاينة والحجز',
    'الدردشة المباشرة مع العملاء',
    'إشعارات فورية للطلبات الجديدة',
    'ملف تعريفي للوكيل (تقييمات وسجل مبيعات)',
