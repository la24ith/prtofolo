...
// أضف هذا الثيم مع باقي الثيمات في الأعلى
const sallaTheme: CaseStudyTheme = {
  primary: '#0E6F5C',
  primaryDark: '#0A4F41',
  primaryMid: '#1a8f76',
  primaryLight: '#E3EFEC',
...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    hero: {
      badge: '📱 Flutter · Supabase · تطبيق موبايل',
      title: 'دكان — متجر إلكتروني للسوق السوري',
      subtitle:
        'منصة تجارة إلكترونية متكاملة: تطبيق زبائن بـ 17 شاشة مع كل قواعد العمل — كوبونات، بحث ذكي، تقييمات، مفضلة، ومتابعة طلبات كاملة.',
      stats: [
        { n: '17', l: 'شاشة للزبون' },
        { n: 'Offline', l: 'يعمل بدون إنترنت' },
        { n: 'Supabase', l: 'Backend + RLS' },
        { n: 'COD', l: 'دفع عند الاستلام' },
      ],
    },
    overview: {
      label: 'نظرة عامة',
      title: 'ما هو التطبيق؟',
      desc:
        'سلة تطبيق تجارة إلكترونية مصمم خصيصًا للسوق السوري، يتيح للزبون تصفح المنتجات، إضافتها للسلة، ' +
        'تطبيق كوبونات الخصم، وإتمام الطلب بالدفع عند الاستلام — مع متابعة كاملة لحالة الطلب وإمكانية ' +
        'الإلغاء خلال 15 دقيقة. كل العمليات الحرجة تمر عبر RPCs مخصصة تضمن أمان المخزون والكوبونات.',
      statCards: [
        { n: '17', l: 'شاشة كاملة' },
        { n: '14', l: 'محافظة سورية' },
        { n: '15\'', l: 'مهلة إلغاء الطلب' },
        { n: 'RLS', l: 'أمان على مستوى الصف' },
      ],
    },
    apps: {
      label: 'التطبيق',
      ...
      items: [
        {
          icon: '🛍️',
          name: 'تطبيق دكان للزبون',
          sub: 'Flutter · Android + iOS · 17 شاشة',
          accent: 'jade',
          features: [
            {
              title: 'بحث ذكي يتحمل الأخطاء الإملائية',
              desc: 'بحث نصي عبر pg_trgm مع فلاتر متقدمة (تصنيف، سعر، توفر) وتحميل لا نهائي.',
            },
            {
              title: 'سلة وكوبونات خصم',
              desc: 'تحقق فوري من الكود بالواجهة، وعرض الخصم قبل تأكيد الطلب — التحقق الملزم داخل RPC.',
            },
            {
              title: 'عناوين توصيل متعددة',
              desc: 'إدارة عناوين التوصيل مع عنوان افتراضي، واختيار العنوان مباشرة من شاشة الدفع.',
            },
            {
              title: 'متابعة الطلبات مع Timeline',
              desc: 'خمس حالات واضحة مع timeline كامل، وزر إلغاء خلال 15 دقيقة يعيد المخزون والكوبون تلقائيًا.',
            },
            {
              title: 'تقييمات المنتجات',
              desc: 'تقييم واحد لكل مستخدم لكل منتج — الاسم يُخزَّن كـ Snapshot لحماية خصوصية الهاتف.',
            },
            {
              title: 'قائمة مفضلة Optimistic',
              desc: 'زر القلب يستجيب فورًا مع rollback تلقائي عند فشل الشبكة — بدون spinner مزعج.',
            },
            {
              title: 'وضع الزائر مع دمج ذكي',
              desc: 'تسوّق بدون حساب، وعند تسجيل الدخول يُعرض dialog لدمج سلة الزائر مع الحساب.',
            },
            {
              title: 'يعمل بدون إنترنت',
              desc: 'شاشة انقطاع تلقائية تظهر عند فقدان الاتصال وتختفي عند عودته.',
            },
          ],
        },
      ],
    ...
    workflow: {
      ...
      desc:
        'كل تغيير على حالة الطلب يمر حصرًا عبر RPCs مخصصة — لا يمكن للتطبيق تحديث الحالة مباشرة. ' +
        'هذا يضمن تنفيذ كل الآثار الجانبية (مخزون، كوبون، timeline) في نفس الـ transaction.',
      steps: [
        '⏳ قيد الانتظار',
        '✅ مؤكد',
        '📦 قيد التحضير',
      ...
      altPaths: [
        {
          from: '⏳ قيد الانتظار فقط',
          to: '❌ ملغي (خلال 15 دقيقة)',
          note: '— من الزبون',
          danger: true,
        },
        {
    ...
    techStack: {
      ...
      items: [
        { name: 'Flutter + Dart', desc: 'Android + iOS من كودبيس واحد', color: '#0E6F5C' },
        { name: 'Supabase', desc: 'Database + Auth + Storage + RLS', color: '#3ECF8E' },
        { name: 'flutter_bloc (Cubit)', desc: 'إدارة الحالة بدون boilerplate', color: '#C08A2E' },
        { name: 'Clean Architecture', desc: 'Data / Domain / Presentation', color: '#6B2C43' },
        { name: 'GetIt', desc: 'Dependency Injection يدوي', color: '#4A90D9' },
        { name: 'Hive', desc: 'سلة الزائر + Cache محلي', color: '#E8A020' },
        { name: 'dartz', desc: 'Either<Failure, T> — معالجة أخطاء آمنة', color: '#0E6F5C' },
        { name: 'pg_trgm', desc: 'بحث يتحمل الأخطاء الإملائية', color: '#B23A2E' },
      ],
    },
    highlights: {
      label: 'قرارات معمارية',
      title: 'أبرز القرارات التقنية',
      items: [
        {
          icon: '🛡️',
          title: 'لا UPDATE مباشر على الطلبات',
          desc: 'كل تغيير حالة عبر RPC فقط — يضمن تنفيذ مخزون + كوبون + timeline في transaction واحدة لا تنكسر.',
        },
        {
          icon: '🔒',
          title: 'منع التلاعب بالمخزون',
          desc: 'FOR UPDATE lock على الصفوف وقت إنشاء الطلب — لا يمكن طلب كمية غير متوفرة حتى مع طلبات متزامنة.',
        },
        {
          icon: '📸',
          title: 'Snapshot الأسعار',
          desc: 'الاسم والسعر يُخزَّنان وقت الطلب — تغيير سعر المنتج لاحقًا لا يؤثر على الفواتير القديمة.',
        },
        {
          icon: '👻',
          title: 'وضع الزائر مع دمج ذكي',
          desc: 'سلة الزائر محفوظة بـ Hive محليًا — عند تسجيل الدخول يُعرض dialog لتأكيد الدمج.',
        },
        {
          icon: '⚡',
          title: 'Optimistic UI بالمفضلة',
          desc: 'زر القلب يستجيب فورًا ثم يرسل للسيرفر — مع rollback تلقائي عند الفشل.',
        },
        {
          icon: '⚠️',
          title: 'حد 5 طلبات مفتوحة',
          desc: 'منع الطلبات الوهمية — لا دفع مسبق ولا OTP، فالحد يحمي المخزون من الحجز العشوائي.',
        },
      ],
    },
    roadmap: {
      label: 'خريطة التطوير',
      title: 'ثلاث مراحل، منتج واحد',
      desc: 'كل مرحلة تنتج تطبيقًا قابلًا للاستخدام الفعلي — لا كود ناقص، لا انتظار لإكمال كل شيء قبل التجربة.',
      phases: [
        {
          phase: 'V0',
          title: 'المسار الحرج',
          desc: 'تسجيل دخول → تصفح منتجات → إضافة للسلة → طلب فعلي يصل لقاعدة البيانات بالحالة والمبلغ الصحيحَين.',
          status: 'done',
        },
        {
          phase: 'V1',
          title: 'اكتمال قواعد العمل + الأدمن',
          desc: '17 شاشة كاملة (كوبونات، إلغاء، بحث، تقييمات، Wishlist، عناوين، Offline) + لوحة تحكم الأدمن بـ 5 تبويبات.',
          status: 'done',
        },
        {
          phase: 'V2',
          title: 'جاهزية الإطلاق الفعلي',
          desc: 'إشعارات FCM، Force Update / Maintenance Mode، اختبارات على المنطق الحرج، Deep Linking، App Store assets.',
          status: 'soon',
        },
      ],
    },
    cta: {
      title: 'هل تريد متجرًا إلكترونيًا مشابهًا؟',
      desc: 'أبني تطبيقات Flutter تجارية احترافية بـ Backend متكامل — من الفكرة للإطلاق.',
      primaryHref: '/#contact',
      primaryLabel: 'تواصل معي',
      footnote: 'la24ithdev@gmail.com',
    },
...

  {
    ...
    theme: sallaTheme,
    hero: {
      badge: '⚙️ Flutter · Supabase · لوحة تحكم',
      title: 'دكان — لوحة تحكم المتجر الإلكتروني',
      subtitle:
        'تطبيق موبايل احترافي لإدارة متجر سلة بالكامل — طلبات، منتجات، تصنيفات، كوبونات، ورسوم توصيل، مع حماية صارمة للأدمن فقط.',
      stats: [
        { n: '5', l: 'تبويبات إدارية' },
        { n: 'RPC', l: 'تحديث حالة الطلبات' },
        { n: 'Storage', l: 'رفع صور مضغوطة' },
        { n: 'RBAC', l: 'أمان متعدد الطبقات' },
      ],
    },
    overview: {
      label: 'نظرة عامة',
      title: 'ما هو التطبيق؟',
      desc:
        'دكان لوحة تحكم Flutter مستقلة تمامًا عن تطبيق الزبون، تتيح للأدمن إدارة المتجر يوميًا من موبايله — ' +
        'تحديث حالة الطلبات بالتسلسل الصحيح، إضافة المنتجات مع رفع صور مضغوطة تلقائيًا، إنشاء كوبونات الخصم، ' +
        'وضبط رسوم التوصيل لكل محافظة سورية. الوصول مقيّد للأدمن فقط بفحص متعدد الطبقات.',
      statCards: [
        { n: '5', l: 'تبويبات إدارية' },
        { n: '14', l: 'محافظة سورية' },
        { n: '5', l: 'حالات الطلب' },
        { n: 'JWT', l: 'فحص role بعد الدخول' },
      ],
    },
    apps: {
      label: 'التطبيق',
      title: 'إدارة كاملة من الموبايل',
      items: [
        {
          icon: '📋',
          name: 'تبويب الطلبات',
          sub: 'قائمة · بحث · تفاصيل · تحديث الحالة',
          accent: 'jade',
          features: [
            {
              title: 'قائمة الطلبات مع فلتر الحالة',
              desc: 'بحث بالاسم أو رقم الطلب، وفلترة سريعة بين: انتظار، مؤكد، تحضير، شحن، مُسلَّم، ملغي.',
            },
            {
              title: 'تفاصيل الطلب الكاملة',
              desc: 'بيانات الزبون والهاتف والعنوان، قائمة المنتجات مع أسعارها، ملخص المبالغ، وtimeline كامل.',
            },
            {
              title: 'تحديث الحالة بالتسلسل الصحيح',
              desc: 'Dialog يعرض الحالات المتاحة فقط حسب الحالة الحالية — يستدعي update_order_status RPC مباشرة.',
            },
          ],
        },
        {
          icon: '📦',
          name: 'تبويب المنتجات',
          sub: 'CRUD · رفع صور · تعديل مخزون',
          accent: 'brass',
          features: [
            {
              title: 'إضافة وتعديل المنتجات',
              desc: 'فورم كامل: تصنيف، اسم، وصف، سعر، مخزون، صورة — مع تفعيل/إخفاء المنتج من نفس الشاشة.',
            },
            {
              title: 'رفع صور مضغوطة تلقائيًا',
              desc: 'flutter_image_compress يضغط الصورة قبل الرفع لـ Supabase Storage في مجلد products/.',
            },
            {
              title: 'تعديل المخزون سريعًا',
              desc: 'Dialog مباشر لتعديل الكمية بدون فتح فورم التعديل الكامل.',
            },
          ],
        },
        {
          icon: '🗂️',
          name: 'تبويب التصنيفات',
          sub: 'CRUD · صور · ترتيب · تفعيل',
          accent: 'jade',
          features: [
            {
              title: 'إدارة التصنيفات',
              desc: 'إضافة وتعديل وحذف التصنيفات مع رفع صورة وتحديد رقم الترتيب.',
            },
            {
              title: 'تفعيل وإخفاء',
              desc: 'Switch لتفعيل/إخفاء التصنيف من الواجهة العامة بدون حذفه.',
            },
          ],
        },
        {
          icon: '🎟️',
          name: 'تبويب الكوبونات',
          sub: 'نسبة أو مبلغ ثابت · حد استخدامات · انتهاء',
          accent: 'brass',
          features: [
            {
              title: 'إنشاء كوبونات مرنة',
              desc: 'نسبة مئوية أو مبلغ ثابت، حد أدنى للطلب، حد أقصى للاستخدامات، وتاريخ انتهاء اختياري.',
            },
            {
              title: 'نسخ الكود بضغطة',
              desc: 'الضغط على الكود ينسخه للحافظة فورًا لمشاركته مع الزبائن.',
            },
            {
              title: 'تتبع الاستخدام',
              desc: 'عداد حي يظهر كم مرة استُخدم كل كوبون من الحد المسموح.',
            },
          ],
        },
        {
          icon: '🚚',
          name: 'تبويب رسوم التوصيل',
          sub: 'سعر منفصل لكل محافظة سورية',
          accent: 'jade',
          features: [
            {
              title: 'رسوم مستقلة لكل محافظة',
              desc: 'ضبط سعر توصيل مختلف لكل محافظة من المحافظات الـ 14، مع فلترة المحافظات المضافة.',
            },
            {
              title: 'تعديل الرسوم بسرعة',
              desc: 'Dialog مباشر لتعديل السعر دون الحاجة لفتح شاشة منفصلة.',
            },
          ],
        },
      ],
    ...
    techStack: {
      ...
      items: [
        ...
        { name: 'Clean Architecture', desc: 'Data / Domain / Presentation', color: '#6B2C43' },
        { name: 'GetIt', desc: 'Dependency Injection يدوي', color: '#4A90D9' },
        { name: 'flutter_image_compress', desc: 'ضغط صور قبل الرفع لـ Storage', color: '#555555' },
        { name: 'flutter_dotenv', desc: 'بيئات dev/prod منفصلة', color: '#1a8f76' },
        { name: 'dartz', desc: 'Either<Failure, T> — معالجة أخطاء آمنة', color: '#0E6F5C' },
      ],
    },
    highlights: {
      ...
      items: [
        {
          icon: '🔐',
          title: 'Auth الأدمن متعدد الطبقات',
          desc: 'تسجيل دخول Supabase + فحص role=admin من جدول profiles + فحص تلقائي عند كل Splash — أي تغيير للـ role يطرد الأدمن فورًا.',
        },
        {
          icon: '🛡️',
          title: 'لا UPDATE مباشر على الطلبات',
          desc: 'تحديث الحالة عبر update_order_status RPC فقط — يضمن صحة التسلسل وتسجيل التاريخ تلقائيًا.',
        },
        {
          icon: '🖼️',
          title: 'رفع صور محسّن',
          desc: 'الصورة تُضغط تلقائيًا بـ flutter_image_compress قبل الرفع — توفير باندويث وتسريع التحميل للزبائن.',
        },
        {
          icon: '📁',
          title: 'Storage منظّم بمجلدات',
          desc: 'bucket واحد بمجلدَين: products/ للمنتجات، وcategories/ للتصنيفات — مع policies خاصة بالأدمن فقط.',
        },
        {
          icon: '🌍',
          title: 'رسوم توصيل مرنة',
          desc: 'قائمة المحافظات السورية الـ 14 مدمجة مباشرة في التطبيق — فلترة تلقائية للمحافظات المضافة مسبقًا.',
        },
        {
          icon: '⚡',
          title: 'Future.wait للتحميل الموازي',
          desc: 'تفاصيل الطلب تحمّل بيانات الطلب والمنتجات والـ timeline بثلاثة استعلامات متوازية لا متتالية.',
        },
      ],
    },
    cta: {
      title: 'هل تحتاج لوحة تحكم مشابهة لمتجرك؟',
      desc: 'أبني لوحات تحكم Flutter احترافية تدير متجرك بالكامل من موبايلك — بدون لاب توب، بدون تعقيد.',
      primaryHref: '/#contact',
      primaryLabel: 'تواصل معي',
      footnote: 'la24ithdev@gmail.com',
    },
